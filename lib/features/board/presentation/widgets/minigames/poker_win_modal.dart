...
class PokerWinModal extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PokerWinModal> createState() => _PokerWinModalState();
}

class _PokerWinModalState extends ConsumerState<PokerWinModal>
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        // Nombre del Ganador
                        Text(
                          widget.winner.username.toUpperCase(),
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 42,
                            fontFamily: 'Retro Gaming',
